...
//        System.out.println(Arrays.toString(cars));
        ...
        String[][] brandModel = new String [2][cars.length];
        int j = 0;


        for (int i = 0; i < brandModel.length; i++) {
            for (int k = 0; k < cars.length; k++) {
                if(i == 0){
                    brandModel[i][k] = cars[k].substring(0, cars[k].indexOf("-"));
                }else{
                    brandModel[i][k] = cars[k].substring(cars[k].indexOf("-") + 1);
                }
        ...
        System.out.println(Arrays.deepToString(brandModel));
